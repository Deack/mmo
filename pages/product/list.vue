...
<script>
	...
	export default {
		...
		methods: {
			//加载分类
			async loadCateList(fid=1, sid=7){
				await uni.request({
					url: 'http://47.93.63.79:8086/app/home/productCateList/'+fid,
					method:'GET',
					success: (res) => {
			...
			async loadData(type='add', loading) {
				...
				// 分页请求数据
				await uni.request({
					url: 'http://47.93.63.79:8086/app/home/recommendProductList',
					method:'GET',
					data:{
